<?php
$titulo = 'Resumen de Ventas de Artículos';
...
<div class="container-fluid">
    ...
    <table border="0" cellspacing="5" cellpadding="5">
        <tbody>
            ...
            <td>Empresa:</td>
            <td>
                <select style="width:200px;" class="form-control" name="cbociaResumenVentasArticulos" id="cbociaResumenVentasArticulos" multiple="multiple">
                    <option value='-1' selected >.: Todos :.</option>
                    <!-- <option>1Elija una Empresa</option>
                    <option>2Elija una Empresa</option> -->
                </select>
            </td>
            <td><button id="btnResumenVentasArticulos" type="button" class="btn btn-primary">Consultar</button></td>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="table-responsive">
                <table id="tblResumenVentasArticulos" class="table table-striped table-bordered" cellspacing="0" width="100%">
...
<script>
    $('#cbociaResumenVentasArticulos').select2();
</script>
